...
switch(_state) do
{
	...
	case 0:
	{
		[[2,"Der Banküberfall ist aus unbekannten Gründen fehlgeschlagen."],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
	...
	case 1:
	{
		[[1,format["$%1 wurden bei dem Banküberfall auf die Staatsbank entwendet.",[_funds] call life_fnc_numberText]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
		_vault setVariable["fed_locked",true,true];
