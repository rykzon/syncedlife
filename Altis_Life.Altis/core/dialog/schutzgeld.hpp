class Life_schutzgeld_give
{
	idd = 2650;
	name = "life_schutzgeld_give";
	movingEnabled = false;
	...
	class controls 
	{
		...
		class payTicket: Life_RscButtonMenu {
			...
			onButtonClick = "[] call life_fnc_schutzgeldFordern";
			x = 0.45;
			y = 0.35;
			w = (6.25 / 40);
			h = (1 / 25);
...
class Life_schutzgeld_pay
{
	idd = 2600;
	name = "life_schutzgeld_pay";
	movingEnabled = false;
	enableSimulation = true;
	...
	class controls 
	{
		...
		class payTicket: Life_RscButtonMenu {
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] call life_fnc_schutzgeldZahlen;";
