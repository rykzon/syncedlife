...
#define STR_TOSS_ROPES "Seile auswerfen"
#define STR_FAST_ROPE "Abseilen"
#define STR_CUT_ROPES "Seile entfernen"
...
zlt_rope_helis = ["","I_Heli_Transport_02_F","B_Heli_Transport_01_F","B_Heli_Light_01_F","O_Heli_Light_02_unarmed_F","O_Heli_Transport_04_covered_F","",""];
zlt_rope_helidata = 
[
	[
		["O_Heli_Light_02_unarmed_F", "O_Heli_Transport_04_covered_F"],
		[1.35,1.35,-24.95],
		[-1.45,1.35,-24.95]
	],
	[
...
zlt_fnc_ropes_cond = {
	_veh = vehicle player;
	_flag = (_veh != player) and {(not zlt_mutexAction)} and {count (_veh getvariable ["zlt_ropes", []]) == 0} and { (typeof _veh) in zlt_rope_helis } and {driver  _veh == player} and {alive player and alive _veh and (abs (speed _veh) < MAX_SPEED_ROPES_AVAIL ) };
	_flag;
