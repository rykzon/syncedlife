...
case "Land_i_House_Small_01_V1_F": {[1,2]};
case "Land_i_House_Small_01_V2_F": {[1,2]};
case "Land_i_House_Small_01_V3_F": {[1,2]};
case "Land_i_House_Small_02_V1_F": {[1,2]};
case "Land_i_House_Small_02_V2_F": {[1,2]};
case "Land_i_House_Small_02_V3_F": {[1,2]};
