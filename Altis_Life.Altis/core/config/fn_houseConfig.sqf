...
switch (true) do {
	...
	case (_house in ["Land_i_House_Big_01_V1_F","Land_i_House_Big_01_V2_F","Land_i_House_Big_01_V3_F"]): {[30000000,3]};
	case (_house in ["Land_i_Garage_V1_F","Land_i_Garage_V2_F"]): {[8000000,0]};
	...
	case (_house in ["Land_i_House_Small_03_V1_F"]): {[10000000,1]};
	case (_house in ["Land_i_Stone_HouseSmall_V2_F","Land_i_Stone_HouseSmall_V1_F","Land_i_Stone_HouseSmall_V3_F"]): {[10000000,1]};
	default {[]};
};