...
switch (true) do
{
	case (player distance (getMarkerPos "copper_1") < 30): {_mine = "copperu"; _val = 2;};
	case (player distance (getMarkerPos "wood_1") < 30): {_mine = "wood"; _val = 2;};
	case (player distance (getMarkerPos "iron_1") < 30): {_mine = "ironu"; _val = 2;};
	...
	case (player distance (getMarkerPos "stone_1") < 50): {_mine = "stone"; _val = 2;};
