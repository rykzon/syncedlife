...
class life_extended_admin_menu {
	...
	class controls 
	{
		...
		{
			idc = 2405;
			text = "Spect."; //--- ToDo: Localize;
			x = 21.5 * GUI_GRID_W + GUI_GRID_X;
			y = 13 * GUI_GRID_H + GUI_GRID_Y;
			w = 4 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
			colorText[] = {0.5,0.5,0,1};
			tooltip = "Spectate Players";
			onButtonClick = "closeDialog 0; [] call life_fnc_adminSpectate;";
		};
	    class player_b_gear: Life_RscButtonMenu
		{
			idc = 2417;
			...
			h = 1 * GUI_GRID_H;
			colorText[] = {0.5,0.5,0,1};
			tooltip = "Inventar und Geld überprüfen";
		...
		class player_b_tpHere: Life_RscButtonMenu
		{
			...
			w = 4 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
			tooltip = "Spieler zu mir porten"; //--- ToDo: Localize;
