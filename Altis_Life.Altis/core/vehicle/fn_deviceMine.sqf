...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1","coal_1","malz_1","hopfen_1","pilze_1"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["coal_1"]): {"coalu"};
	case (_zone in ["pilze_1"]): {"pilze"};
	case (_zone in ["malz_1"]): {"malz"};
	case (_zone in ["hopfen_1"]): {"hopfen"};
	default {""};
};
